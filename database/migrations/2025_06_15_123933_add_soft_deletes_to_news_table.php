 ...
 * for the 'news' table in the database.
 *
...
return new class extends Migration
{
    ...
    {
        // Modify the 'news' table.
        Schema::table('news', function (Blueprint $table) {
            // Add the 'deleted_at' timestamp column to the 'news' table.
    ...
    {
        // Modify the 'news' table to revert changes.
        Schema::table('news', function (Blueprint $table) {
            // Remove the 'deleted_at' column from the 'news' table.
