 ...
 * for the 'galleries' table in the database.
 *
...
return new class extends Migration
{
    ...
    {
        // Modify the 'galleries' table.
        Schema::table('galleries', function (Blueprint $table) {
            // Add the 'deleted_at' timestamp column to the 'galleries' table.
    ...
    {
        // Modify the 'galleries' table to revert changes.
        Schema::table('galleries', function (Blueprint $table) {
            // Remove the 'deleted_at' column from the 'galleries' table.
