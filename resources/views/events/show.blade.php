...
<head>
    ...
    {{-- meta dinamis langsung dari $event --}}
    <title>{{ $event->title }} | Taste of Indonesia</title>
    <meta name="description" content="{{ \Illuminate\Support\Str::limit(strip_tags($event->desc), 160) }}">
    <meta name="keywords" content="{{ $event->meta_keywords ?? 'Taste of Indonesia, Event' }}">
    <meta property="og:title" content="{{ $event->title }}">
    <meta property="og:description" content="{{ \Illuminate\Support\Str::limit(strip_tags($event->desc), 160) }}">
    <meta property="og:image" content="{{ asset('storage/' . $event->image_events) }}">
...
<body class="body-fixed">
    ...
    <section class="faq-sec section-repeat-img" style="background-image: url('{{ asset('assets/images/faq-bg.png') }}');"
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="sec-title text-center mb-5">
                    <p class="sec-sub-title calendar-events mb-3">ANOTHER EVENTS</p>
                    <div class="about_us">
                        <h2>Another Events </h2>
                        <h2>
                            from <span class="rasa-text"> Taste </span>of Indonesia
                        </h2>
                    </div>
                    <div class="sec-title-shape mb-4">
