        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item position-relative me-3">
                    <button id="openCartBtn" class="btn btn-cart rounded-pill d-flex align-items-center">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Fungsi untuk tutup navbar jika sedang terbuka dan layar mobile
        function closeNavbarIfMobile() {
            if (window.innerWidth <= 991 && navbarCollapse.classList.contains('show')) {
                // Pakai bootstrap Collapse API untuk toggle
                const bsCollapse = bootstrap.Collapse.getInstance(navbarCollapse) || new bootstrap.Collapse(navbarCollapse);
                bsCollapse.hide();
            }
        }

        // Event tombol close navbar
        closeNavbarBtn.addEventListener('click', function() {
            closeNavbarIfMobile();
        });

        // Event tombol Cart di navbar
