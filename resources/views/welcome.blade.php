...
<div class="row">
    ...
    <div class="col-lg-4 col-sm-6 dish-box-wp" data-cat="{{ $business->type_id }}">
        <div class="dish-box text-center">
            ...
            <div class="dish-title">
                <h3 class="h3-title">{{ $business->name_business }}</h3>
                <p>{{ $business->type->name }}</p>
            </div>
            ...
            <div class="menu-tab text-center">
                <a href="{{ route('show', $business->id) }}" class="btn btn-primary">Details</a>
            </div>
        </div>
    </div>
    @endforeach
            ...
            <div class="row">
                <div class="testimonials-container">
                    <div class="swiper-container">
                        ...
                        <!-- If there are more than 4 testimonials, show the navigation buttons -->
                        @if($business->testimonials->count() > 4)
